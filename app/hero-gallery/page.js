...
export default function HeroGallery() {
  ...
  return (
    <div className="bg-[#050508] min-h-screen text-white font-inter">
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 bg-black/90 backdrop-blur-xl border border-white/10 rounded-full px-6 py-3 flex flex-col items-center shadow-2xl">
        <span className="font-mono text-[10px] text-[#8e8e9f] uppercase tracking-widest mb-2">Select Variant</span>
